    ...
    <div className="flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky top-0 z-50">
      ...
      <div className="flex tems-center justify-center gap-5">
        <form onSubmit={e=>{
          ...
          <div className="flex bg-zinc-900 h-10 pr-0 items-center px-4">
            ...
            <button className="h-10 w-16 items-center bg-zinc-800 justify-center pl-2">
              <AiOutlineSearch className="text-xl " />
            </button>
          </div>
        </form>
      ...
      <div className="flex gap-5 items-center text-xl">
        ...
        <img
          src="https://yt3.ggpht.com/yti/AOXPAcUFbjr9C7eNMDBb0dY9-9W6_om3PDwPxSjhd9pIgg=s88-c-k-c0x00ffffff-no-rj"

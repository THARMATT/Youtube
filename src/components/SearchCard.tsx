  ...
  return (
    <div className="flex gap-3">
      <div className="relative">
        <span className="absolute bottom-3 right-3 text-sm bg-gray-900 z-10 px-2 py-0.5">
          {data.videoDuration}
        </span>
      ...
      <div className="flex gap-1 flex-col ">
        ...
        <div className="text-xs text-gay-400">
          <div>
            <div>
        ...
        <div className="min-w-fit my-2">
          <a href="#" className="flex items-center gap-2 text-xs text-gray-400">
            <img src={data.channelInfo.image} alt="" className="h-9 w-9 rounded-full" />
